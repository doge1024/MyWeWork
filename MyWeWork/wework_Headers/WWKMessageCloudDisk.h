...
{
    unsigned long long _assistMessageType;
    NSString *_topicName;
    NSString *_wording;
    NSString *_mainTitle;
    NSString *_subTitle;
    ...
    NSMutableArray *_selObjectIdList;
}

+ (_Bool)supportsMergeForwarding;
+ (_Bool)supportsForwarding;
@property(retain, nonatomic) NSMutableArray *selObjectIdList; // @synthesize selObjectIdList=_selObjectIdList;
...
@property(nonatomic) unsigned long long assistMessageType; // @synthesize assistMessageType=_assistMessageType;
- (void).cxx_destruct;
