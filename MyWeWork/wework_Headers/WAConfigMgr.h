...
- (void)setDebugModeDownloadPkgCompleteWithAppid:(id)arg1 debugType:(unsigned long long)arg2 packageType:(unsigned int)arg3 moduleName:(id)arg4 value:(_Bool)arg5;
- (_Bool)isDebugModeAlreadyUpdatePkgWithAppid:(id)arg1 debugType:(unsigned long long)arg2 packageType:(unsigned int)arg3 moduleName:(id)arg4;
