...
@class CContact, NSArray, NSDictionary, NSString, UINavigationController, WAAppTaskExtInfo, WAAppTaskLoadingViewInfo, WACacheVersionChecker, WALoadingViewController, WAPackageConfig, WAPermissionHandler, WAWebViewController;
