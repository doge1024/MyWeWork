...
@class NSString, WWKScrollActionSheet;

@interface JWeixinNativeCodeHandler_saveImage : NativeCodeHandlerBase <WWKForwardingControllerDelegate>
{
    NSString *_qrscanResult;
    WWKScrollActionSheet *_actionSheet;
}

+ (_Bool)requiresPermission;
@property(retain, nonatomic) WWKScrollActionSheet *actionSheet; // @synthesize actionSheet=_actionSheet;
