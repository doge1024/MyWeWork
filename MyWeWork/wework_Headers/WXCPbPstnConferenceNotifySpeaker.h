...
@interface WXCPbPstnConferenceNotifySpeaker : WXPPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSMutableArray *speakers; // @dynamic speakers;
@property(nonatomic) unsigned int speakingduration; // @dynamic speakingduration;
