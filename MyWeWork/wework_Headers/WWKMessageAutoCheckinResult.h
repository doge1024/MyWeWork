...
@interface WWKMessageAutoCheckinResult : WWKMessageMedia
{
    NSString *_title;
    NSString *_summary;
    NSString *_row1Text;
    ...
    unsigned long long _exception_type;
}

+ (_Bool)supportsMergeForwarding;
+ (_Bool)supportsForwarding;
@property(nonatomic) unsigned long long exception_type; // @synthesize exception_type=_exception_type;
