...
@class CAShapeLayer, NSArray, NSMutableArray, NSMutableDictionary, NSString, UIColor, UIFont, UIView;
...
@property(nonatomic) _Bool smoothChangeValues; // @synthesize smoothChangeValues=_smoothChangeValues;
...
- (id)getLegendWithMinWidth:(double)arg1;
...
- (void)strokeChartWithSmoothAnimation;
