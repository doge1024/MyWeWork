...
@protocol WWKCustomerInputToolBarDelegate;

@interface WWKCustomerInputToolBar : UIControl <QMUITextViewDelegate>
{
    _Bool _shouldManageKeyboardAndPanelEventAutomatically;
    _Bool _isKeyboardShowing;
    id <WWKCustomerInputToolBarDelegate> _delegate;
...
@property(nonatomic) __weak id <WWKCustomerInputToolBarDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
