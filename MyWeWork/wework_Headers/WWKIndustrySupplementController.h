...
@class NSArray, NSString, WWKIndustrySupplementFooter;

@interface WWKIndustrySupplementController : UITableViewController <WWKCommonSettingControllerDelegate>
{
    NSArray *_dataSource;
    ...
    WWKIndustrySupplementFooter *_footer;
}

@property(retain, nonatomic) WWKIndustrySupplementFooter *footer; // @synthesize footer=_footer;
@property(copy, nonatomic) CDUnknownBlockType callback; // @synthesize callback=_callback;
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)controller:(id)arg1 onItemSelected:(long long)arg2;
- (void)p_updateSubmitBtnEnable;
- (void)submitInfo;
...
- (id)p_sectionTitle:(long long)arg1;
