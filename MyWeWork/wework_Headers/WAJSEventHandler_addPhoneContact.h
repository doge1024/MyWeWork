...
@interface WAJSEventHandler_addPhoneContact : WAJSEventHandler_BaseEvent <CNContactViewControllerDelegate, CNContactPickerDelegate, ABPeoplePickerNavigationControllerDelegate, ABNewPersonViewControllerDelegate>
{
