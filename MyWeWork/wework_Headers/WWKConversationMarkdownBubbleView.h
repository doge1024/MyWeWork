...
@class NSString, WWKInteractiveLabel, WWKMessageText;

@interface WWKConversationMarkdownBubbleView : WWKConversationMessageBubbleView <WWKInteractiveLabelDelegate>
{
