...
@class NSString, UISearchDisplayController, UITableView, UIView, WWKGlobalSearchController, WWKMarketCategoryListView, WWKPstnCalllogLoadingView, WWKSearchBar;

@interface WWKMarketListViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, WWKMarketCategoryListViewDelegate>
{
    int _categoryId;
