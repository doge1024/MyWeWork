...
@interface WXCPbSCSyncResp : WXPPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSData *cmdList; // @dynamic cmdList;
@property(nonatomic) int continueFlag; // @dynamic continueFlag;
@property(retain, nonatomic) NSData *oplogResults; // @dynamic oplogResults;
