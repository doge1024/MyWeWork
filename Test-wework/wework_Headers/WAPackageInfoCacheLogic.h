...
- (_Bool)unpackPkgFromPath:(id)arg1 appid:(id)arg2 version:(unsigned long long)arg3 isDebugMode:(unsigned long long)arg4 packageType:(unsigned int)arg5;
- (void)removePackageCacheIfDifferentPackageType:(unsigned int)arg1 appId:(id)arg2 version:(unsigned long long)arg3 isDebugMode:(unsigned long long)arg4;
