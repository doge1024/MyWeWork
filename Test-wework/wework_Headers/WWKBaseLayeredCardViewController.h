...
- (void)show;
- (void)p_switchFromPrivacyControllerMultiJobSelectToMultiJobSelect;
- (void)p_switchFromMultiJobSelectToPrivacyController;
- (void)privacyDidChange:(id)arg1;
- (void)overridePrivacySetting:(id)arg1;
- (id)createCardView;
- (void)privacySettingViewControllerDidClose:(id)arg1;
- (void)privacySettingViewControllerDidClickMultiJobSection:(id)arg1;
