...
@class NSArray, NSData, NSDate, NSDictionary, NSError, NSInputStream, NSMutableArray, NSMutableData, NSMutableDictionary, NSNumber, NSOutputStream, NSRecursiveLock, NSString, NSTimer, NSURL, WXCASIDataDecompressor;
@protocol WXCASICacheDelegate, WXCASIHTTPRequestDelegate, WXCASIHTTPRequestDelegate><WXCASIProgressDelegate, WXCASIProgressDelegate;

@interface WXCASIHTTPRequest : NSOperation <NSCopying>
{
    NSURL *url;
    NSURL *originalURL;
    NSURL *redirectURL;
    id <WXCASIHTTPRequestDelegate> delegate;
    id <WXCASIHTTPRequestDelegate><WXCASIProgressDelegate> queue;
    ...
    id <WXCASIProgressDelegate> uploadProgressDelegate;
    id <WXCASIProgressDelegate> downloadProgressDelegate;
    ...
    NSTimer *statusTimer;
    id <WXCASICacheDelegate> downloadCache;
    int cachePolicy;
    ...
    WXCASIDataDecompressor *dataDecompressor;
    _Bool shouldWaitToInflateCompressedResponses;
    _Bool isPACFileRequest;
    WXCASIHTTPRequest *PACFileRequest;
...
@property(retain, nonatomic) WXCASIHTTPRequest *PACFileRequest; // @synthesize PACFileRequest;
...
@property(retain) WXCASIDataDecompressor *dataDecompressor; // @synthesize dataDecompressor;
...
@property id <WXCASICacheDelegate> downloadCache; // @synthesize downloadCache;
...
@property WXCASIHTTPRequest *mainRequest; // @synthesize mainRequest;
