...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, UIBarButtonItem, UIImageView, UIScreenEdgePanGestureRecognizer, UIView, WWFavoriteId, WWKLoadFailedView, WWKLoadingView, WWKPullBackgroundView, WWKScrollActionSheet, WWKWebBrowserHistory, WWKWebBrowserTitleView, WWKWebViewProgressView;
...
- (_Bool)isCrashedEver;
- (_Bool)syncCheckNavigationRecordCrashedEver;
