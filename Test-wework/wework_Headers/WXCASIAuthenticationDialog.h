...
#import "WXCASIAutorotatingViewController.h"

#import "UIActionSheetDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class NSString, UITableView, UIViewController, WXCASIHTTPRequest;

@interface WXCASIAuthenticationDialog : WXCASIAutorotatingViewController <UIActionSheetDelegate, UITableViewDelegate, UITableViewDataSource>
{
    WXCASIHTTPRequest *request;
    int type;
...
@property(retain) WXCASIHTTPRequest *request; // @synthesize request;
