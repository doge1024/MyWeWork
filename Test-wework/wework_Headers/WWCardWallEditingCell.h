...
@interface WWCardWallEditingCell : WWCardWallCell <QMUITextViewDelegate, UITextFieldDelegate>
{
    _Bool _isEditingMode;
    _Bool _isLastCell;
    _Bool _isNeedKeyLabel;
    _Bool _isHolderComment;
    UILabel *_keyLabel;
    UILabel *_valueLabel;
...
@property(nonatomic, setter=setHolderComment:) _Bool isHolderComment; // @synthesize isHolderComment=_isHolderComment;
