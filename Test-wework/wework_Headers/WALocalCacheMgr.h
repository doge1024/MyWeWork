...
+ (id)getModuleInfoDataWithAppId:(id)arg1 userName:(id)arg2 moduleName:(id)arg3;
+ (id)getDebugModuleInfoDataWithAppId:(id)arg1 userName:(id)arg2 moduleName:(id)arg3;
+ (id)getDefaultInfoDataWithAppId:(id)arg1 userName:(id)arg2;
+ (id)getDebugInfoDataWithAppId:(id)arg1 userName:(id)arg2;
- (void).cxx_destruct;
