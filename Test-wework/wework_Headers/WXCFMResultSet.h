...
@class NSMutableDictionary, NSString, WXCFMDatabase, WXCFMStatement;

@interface WXCFMResultSet : NSObject
{
    WXCFMDatabase *_parentDB;
    WXCFMStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) WXCFMStatement *statement; // @synthesize statement=_statement;
