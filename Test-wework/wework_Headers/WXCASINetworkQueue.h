...
#import "WXCASIHTTPRequestDelegate-Protocol.h"
#import "WXCASIProgressDelegate-Protocol.h"

@class NSDictionary, NSString;

@interface WXCASINetworkQueue : NSOperationQueue <WXCASIProgressDelegate, WXCASIHTTPRequestDelegate, NSCopying>
{
    id delegate;
