...
@interface WWKMeViewController : UITableViewController <WWKForwardingControllerDelegate, WWBBSFellowProxyObserverDelegate, WXApiManagerDelegate, NotificationProxyObserverDelegate, UIGestureRecognizerDelegate, WWKMeInfoHeaderDelegate, WWKCommonWSViewDelegate>
{
    _Bool _needUpdateUI;
