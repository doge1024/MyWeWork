...
QMail.Viewer.prototype._unbindEvents = function() {
    ...
    tdocument.removeEventListener("selectionchange", this._onSelectionChange, false);
}
...
QMail.Viewer.prototype._onSelectionChange = function() {
    QMail.Debug.log('_onSelectionChange');
    QMail.NativeNotifier.notify('selectionChange');
}
